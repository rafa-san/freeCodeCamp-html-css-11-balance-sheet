...
- **Simple selectors:** Identificam elementos com base no nome, ID ou classe.
- **Combinator selectors:** Estilizam elementos com base em relações hierárquicas.
- **Pseudo-class selectors:** Estilizam elementos com base em estados específicos (exemplo: :hover).
- **Pseudo-elements selectors:** Estilizam partes específicas de um elemento (exemplo: ::before e ::after).
- **Attribute selectors:** Estilizam elementos com base em atributos ou valores de atributos.

Além disso, o curso apresenta o uso de tabelas no HTML. Isso inclui aprender a criar, organizar e estilizá-las para que fiquem funcionais e visualmente atrativas.
